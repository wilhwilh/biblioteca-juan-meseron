<?php
	echo $this->Html->css('autocomplete/autocomplete');
?>
<style >
.mytable {
...
<table class="mytable">
	<tr>
		...
		<td>
		<?php
			echo $this->Form->input('h-005', array('label' => false,
				'options' => array(
	...
	<tr>
		<td><label>Tipo de Registro.</label></td>
		<td>
		<?php
		echo $this->Form->input('h-006', array('label' => false,
			'options' => array(
	...
	<tr>
		<td><label>Nivel Bibliográfico.</label></td>
		<td>
		<?php
		echo $this->Form->input('h-007', array('label' => false,
			'options' => array(
	...
	<tr>
		<td><label>Nivel de Codificación.</label></td>
		<td>
		<?php
		echo $this->Form->input('h-017', array('label' => false,
			'options' => array(
				'#' => '# - Nivel completo.',
	...
	<tr>
		<td><label>Forma de catalogación descriptiva.</label></td>
		<td>
		<?php
		echo $this->Form->input('h-018', array('label' => '',
			'options' => array(
				'#' => '# - No es ISBD.',
				'a' => 'a - AACR 2.',
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>008</b></td>
		<td style="width: 60%;"><b>Códigos de información de longitud fija.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('008-06', array('id' => '008-06', 'label' => false, 'div' => false, 
			'options' => array(
	...
	<tr>
		...
		<td>
			<table id="008pf">
				<tr>
					<td>
						<?php echo $this->Form->input('008-07-10', array('id' => '008-07-10', 'label' => false, 'div' => false,
						'options' => array(
					...
					<td>
						<?php echo $this->Form->input('fecha1-008-07-10', array('id' => 'fecha008-07-10', 'label' => false, 'div' => false, 'maxlength' => '6', 'value' => 'yymmdd')); ?>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td>
			<table id="008sf">
				<tr>
					<td>
						<?php echo $this->Form->input('008-11-14', array('id' => '008-11-14', 'label' => false, 'div' => false,
						'options' => array(
					...
					<td>
						<?php echo $this->Form->input('fecha2-008-11-14', array('id' => 'fecha008-11-14', 'label' => false, 'div' => false, 'maxlength' => '6', 'value' => 'yymmdd')); ?>
					</td>
				</tr>
			</table>
		</td>
	...
	<!-- <tr>
		<td><b>008[11-14]</b></td>
		<td>Segunda fecha.</td>
		<td><?php echo $this->Form->input('008-11-14', array('id' => '008-11-14', 'label' => false, 'div' => false)); ?></td>
	</tr> -->
	<tr>
		<td nowrap="nowrap"><b>008 [15-17]</b></td>
		<td>Lugar de publicación, producción o ejecución.</td>
		<td><?php echo $this->Form->input('008-15-17', array('id' => '008-15-17', 'label' => false, 'div' => false,
			'options' => array(
				'aa' => 'Albania',
				'abc' => 'Alberta',
	...
	<tr>
		<td><b>008 [18]</b></td>
		<td>Periodicidad.</td>
		<td><?php echo $this->Form->input('008-18', array('id' => '008-18', 'label' => false, 'div' => false, 
			'options' => array(
	...
	<tr>
		<td><b>008 [19]</b></td>
		<td>Regularidad.</td>
		<td><?php echo $this->Form->input('008-19', array('id' => '008-19', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		<td><b>008 [20]</b></td>
		<td>No definida.</td>
		<td><?php echo $this->Form->input('008-20', array('id' => '008-20', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No definida'
			)
		)); ?></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('008-21', array('id' => '008-21', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		<td><b>008 [35-37]</b></td>
		<td>Lengua.</td>
		<td><?php echo $this->Form->input('008-35-37', array('id' => '008-35-37', 'label' => false, 'div' => false,
			'options' => array(
				'aar' => 'Afar',
				'abk' => 'Abkhaz',
				'ace' => 'Achinese',
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>017</b></td>
		<td style="width: 60%;"><b>Número de copyright o de depósito legal.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('017a', array('id' => '017a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>020</b></td>
		<td style="width: 60%;"><b>Número Internacional Normalizado para Libros (ISBN).</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>ISBN.</td>
		<td><?php echo $this->Form->input('020a', array('id' => '020a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Términos de disponibilidad.</td>
		<td><?php echo $this->Form->input('020c', array('id' => '020c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>ISBN Inválido/Cancelado.</td>
		<td><?php echo $this->Form->input('020z', array('id' => '020z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>022</b></td>
		<td style="width: 60%;"><b>Número Internacional Normalizado para Publicaciones Seriadas (ISSN).</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>ISSN.</td>
		<td><?php echo $this->Form->input('022a', array('id' => '022a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$y</b></td>
		<td>ISSN incorrecto.</td>
		<td><?php echo $this->Form->input('022y', array('id' => '022y', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>ISSN cancelado.</td>
		<td><?php echo $this->Form->input('022z', array('id' => '022z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>028</b></td>
		<td style="width: 60%;"><b>Número de plancha.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('028a', array('id' => '028a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Fuente del número de plancha.</td>
		<td><?php echo $this->Form->input('028b', array('id' => '028b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>040</b></td>
		<td style="width: 60%;"><b>Fuente de la catalogación.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('040a', array('id' => '040a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>041</b></td>
		<td style="width: 60%;"><b>Código de lengua.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('041i1', array('id' => '041i1', 'label' => false, 'div' => false, 
			'options' => array(
	...
	<tr>
		...
		<td><?php echo $this->Form->input('041i2', array('id' => '041i2', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		...
		<td><?php echo $this->Form->input('041a', array('id' => '041a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Código de idioma del sumario o resumen.</td>
		<td><?php echo $this->Form->input('041b', array('id' => '041b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
		<td>Código de idioma original.</td>
		<td><?php echo $this->Form->input('041h', array('id' => '041h', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>044</b></td>
		<td style="width: 60%;"><b>Código del país de la entidad editora/productora.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('044a', array('id' => '044a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>082</b></td>
		<td style="width: 60%;"><b>Número de la Clasificación Decimal Dewey.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('082i1', array('id' => '082i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Completa',
				'1' => '1 - Abreviada'
			), 'selected' => '0'
	...
	<tr>
		...
		<td><?php echo $this->Form->input('082i2', array('id' => '082i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('082a', array('id' => '082a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Número de documento.</td>
		<td><?php echo $this->Form->input('082b', array('id' => '082b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>092</b></td>
		<td style="width: 60%;"><b>Clasificación local (COTA).</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('092a', array('id' => '092a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>A disposición del centro catalogador.</td>
		<td><?php echo $this->Form->input('092b', array('id' => '092b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>A disposición del centro catalogador.</td>
		<td><?php echo $this->Form->input('092c', array('id' => '092c', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>100</b></td>
		<td style="width: 45%;"><b>Punto de acceso principal - Nombre de persona.</b></td>
		<td style="width: 50%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('100i1', array('id' => '100i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Nombre',
				'1' => '1 - Apellido (s)',
	...
	<tr>
		<td><b>I2</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('100i2', array('id' => '100i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('100a', array('id' => '100a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Fechas asociadas al nombre.</td>
		<td><?php echo $this->Form->input('100d', array('id' => '100d', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>110</b></td>
		<td style="width: 60%;"><b>Autor corporativo.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('110i1', array('id' => '110i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No definido',
	...
	<tr>
		<td><b>I2</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('110i2', array('id' => '110i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('110a', array('id' => '110a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Unidad subordinada.</td>
		<td><?php echo $this->Form->input('110b', array('id' => '110b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>130</b></td>
		<td style="width: 60%;"><b>Título uniforme (Punto de acceso).</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('130i1', array('id' => '130i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0',
				'1' => '1',
				'2' => '2',
	...
	<tr>
		<td><b>I2</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('130i2', array('id' => '130i2', 'label' => false, 'div' => false,
			'options' => array(
					'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('130a', array('id' => '130a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('130n', array('id' => '130n', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('130p', array('id' => '130p', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>222</b></td>
		<td style="width: 60%;"><b>Título clave.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('222i1', array('id' => '222i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		<td><b>I2</b></td>
		<td>Caracteres que no alfabetizan.</td>
		<td><?php echo $this->Form->input('222i2', array('id' => '222i2', 'label' => false, 'div' => false,
			'options' => array(
				'0' => '0',
				'1' => '1',
				'2' => '2',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Título clave.</td>
		<td><?php echo $this->Form->input('222a', array('id' => '222a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Información adicional.</td>
		<td><?php echo $this->Form->input('222b', array('id' => '222b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>240</b></td>
		<td style="width: 60%;"><b>Título uniforme.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('240i1', array('id' => '240i1', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		<td><b>I2</b></td>
		<td>Caracteres que no alfabetizan.</td>
		<td><?php echo $this->Form->input('240i2', array('id' => '240i2', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0',
				'1' => '1',
				'2' => '2',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Título uniforme.</td>
		<td><?php echo $this->Form->input('240a', array('id' => '240a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('240n', array('id' => '240n', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('240p', array('id' => '240p', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>245</b></td>
		<td style="width: 60%;"><b>Mención de título.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('245i1', array('id' => '245i1', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		<td><b>I2</b></td>
		<td>Caracteres que no alfabetizan.</td>
		<td><?php echo $this->Form->input('245i2', array('id' => '245i2', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0',
				'1' => '1',
				'2' => '2',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('245a', array('id' => '245a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Subtítulo o título paralelo.</td>
		<td><?php echo $this->Form->input('245b', array('id' => '245b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Mención de responsabilidad.</td>
		<td><?php echo $this->Form->input('245c', array('id' => '245c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
		<td>Tipo de material.</td>
		<td><?php echo $this->Form->input('245h', array('id' => '245h', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>246</b></td>
		<td style="width: 60%;"><b>Variante de título.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('246i1', array('id' => '246i1', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		...
		<td><?php echo $this->Form->input('246i2', array('id' => '246i2', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se especifica',
				'0' => '0 - Parte de título',
				'1' => '1 - Título paralelo',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Título.</td>
		<td><?php echo $this->Form->input('246a', array('id' => '246a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Subtítulo o título paralelo.</td>
		<td><?php echo $this->Form->input('246b', array('id' => '246b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$i</b></td>
		<td>Texto de visualización.</td>
		<td><?php echo $this->Form->input('246i', array('id' => '246i', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>247</b></td>
		<td style="width: 60%;"><b>Título anterior.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Título.</td>
		<td><?php echo $this->Form->input('247a', array('id' => '247a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Subtítulo o título paralelo.</td>
		<td><?php echo $this->Form->input('247b', array('id' => '247b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$f</b></td>
		<td>Fecha o designación secuencial.</td>
		<td><?php echo $this->Form->input('247f', array('id' => '247f', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$g</b></td>
		<td>Nota sobre el título anterior.</td>
		<td><?php echo $this->Form->input('247g', array('id' => '247g', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('247n', array('id' => '247n', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('247p', array('id' => '247p', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>250</b></td>
		<td style="width: 60%;"><b>Mención de edición.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('250a', array('id' => '250a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Resto de la mención de edición.</td>
		<td><?php echo $this->Form->input('250b', array('id' => '250b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>260</b></td>
		<td style="width: 60%;"><b>Publicación, distribución, etc. (pie de imprenta).</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('260a', array('id' => '260a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Nombre del editor, distribuidor, etc <font color="red">(Obligatorio)</font>.</td>
		<td><?php echo $this->Form->input('260b', array('id' => '260b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Fecha de publicación, distribución, etc <font color="red">(Obligatorio)</font>.</td>
		<td><?php echo $this->Form->input('260c', array('id' => '260c', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>300</b></td>
		<td style="width: 60%;"><b>Descripción física.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Extensión.</td>
		<td><?php echo $this->Form->input('300a', array('id' => '300a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Otras características físicas.</td>
		<td><?php echo $this->Form->input('300b', array('id' => '300b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Dimensiones.</td>
		<td><?php echo $this->Form->input('300c', array('id' => '300c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Material anejo.</td>
		<td><?php echo $this->Form->input('300e', array('id' => '300e', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>310</b></td>
		<td style="width: 60%;"><b>Periodicidad actual.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('310a', array('id' => '310a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Fecha de comienzo de la periodicidad actual.</td>
		<td><?php echo $this->Form->input('310b', array('id' => '310b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>321</b></td>
		<td style="width: 60%;"><b>Periodicidad anterior.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('321a', array('id' => '321a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Fechas de la periodicidad anterior.</td>
		<td><?php echo $this->Form->input('321b', array('id' => '321b', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>362</b></td>
		<td style="width: 60%;"><b>Fechas de publicación y/o designación secuencial.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('362a', array('id' => '362a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>380</b></td>
		<td style="width: 60%;"><b>Forma de la obra.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('380a', array('id' => '380a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>500</b></td>
		<td style="width: 60%;"><b>Nota general.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Nota general.</td>
		<td><?php echo $this->Form->input('500a', array('id' => '500a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>501</b></td>
		<td style="width: 60%;"><b>Nota de “Con”.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Con.</td>
		<td><?php echo $this->Form->input('501a', array('id' => '501a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>505</b></td>
		<td style="width: 60%;"><b>Nota de contenido con formato.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('505i1', array('id' => '505i1', 'label' => false, 'div' => false, 
			'options' => array(
	...
	<tr>
		...
		<td><?php echo $this->Form->input('505i2', array('id' => '505i2', 'label' => false, 'div' => false,
			'options' => array(
					'#' => '# - Básico',
					'0' => '0 - Completo'
			)
	...
	<tr>
		...
		<td><?php echo $this->Form->input('505a', array('id' => '505a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>510</b></td>
		<td style="width: 60%;"><b>Nota de citas o referencias bibliográficas.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('510i1', array('id' => '510i1', 'label' => false, 'div' => false, 
			'options' => array(
	...
	<tr>
		<td><b>I2</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('510i2', array('id' => '510i2', 'label' => false, 'div' => false,
			'options' => array(
					'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('510a', array('id' => '510a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Localización dentro de la fuente.</td>
		<td><?php echo $this->Form->input('510c', array('id' => '510c', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>515</b></td>
		<td style="width: 60%;"><b>Nota de peculiaridades de la numeración.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('515a', array('id' => '515a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>520</b></td>
		<td style="width: 60%;"><b>Nota de sumario, etc.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Control de visualización asociada.</td>
		<td><?php echo $this->Form->input('520i1', array('id' => '520i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - Sumario',
				'0' => '0 - Materia',
				'1' => '1 - Reseña',
	...
	<tr>
		<td><b>I2</b></td>
		<td>No definido.</td>
		<td><?php echo $this->Form->input('520i2', array('id' => '520i2', 'label' => false, 'div' => false,
			'options' => array(
					'#' => '# - No definido'
			)
		)); ?></td>
	...
	<tr>
		<td><b>$a</b></td>
		<td>Sumario, etc.</td>
		<td><?php echo $this->Form->input('520a', array('id' => '520a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>530</b></td>
		<td style="width: 60%;"><b>Nota de formato físico adicional disponible.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('530a', array('id' => '530a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Condiciones de adquisición.</td>
		<td><?php echo $this->Form->input('530c', array('id' => '530c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Dirección electrónica.</td>
		<td><?php echo $this->Form->input('530u', array('id' => '530u', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>534</b></td>
		<td style="width: 60%;"><b>Nota sobre la versión original.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Autor.</td>
		<td><?php echo $this->Form->input('534a', array('id' => '534a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Publicación, distribución, etc. del original.</td>
		<td><?php echo $this->Form->input('534c', array('id' => '534c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$l</b></td>
		<td>Localización del original.</td>
		<td><?php echo $this->Form->input('534l', array('id' => '534l', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Frase introductoria.</td>
		<td><?php echo $this->Form->input('534p', array('id' => '534p', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>546</b></td>
		<td style="width: 60%;"><b>Nota de lengua.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('546a', array('id' => '546a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Información sobre el código o alfabeto.</td>
		<td><?php echo $this->Form->input('546c', array('id' => '546c', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>555</b></td>
		<td style="width: 60%;"><b>Nota de índice acumulativo u otros instrumentos bibliográficos.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('555a', array('id' => '555a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Fuente de la adquisición.</td>
		<td><?php echo $this->Form->input('555b', array('id' => '555b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Referencia bibliográfica.</td>
		<td><?php echo $this->Form->input('555d', array('id' => '555d', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Dirección electrónica.</td>
		<td><?php echo $this->Form->input('555u', array('id' => '555u', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>588</b></td>
		<td style="width: 60%;"><b>Nota de fuente de la descripción.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('588a', array('id' => '588a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td><b>600</b></td>
		<td><b>Punto de acceso adicional de materia - Nombre de persona.</b></td>
		<td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('600i1', array('id' => '600i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No definido',
				'0' => '0 – Nombre',
				'1' => '1 - Apellido(s)',
	...
	<tr>
		<td><b>I2</b></td>
		<td>Tesauro.</td>
		<td><?php echo $this->Form->input('600i2', array('id' => '600i2', 'label' => false, 'div' => false,
			'options' => array(
	...
	<tr>
		...
		<td><?php echo $this->Form->input('600a', array('id' => '600a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Fechas asociadas al nombre.</td>
		<td><?php echo $this->Form->input('600d', array('id' => '600d', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Títulos y otros términos asociados al nombre.</td>
		<td><?php echo $this->Form->input('600c', array('id' => '600c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Término indicativo de función.</td>
		<td><?php echo $this->Form->input('600e', array('id' => '600e', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$v</b></td>
		<td>Subdivisión de forma.</td>
		<td><?php echo $this->Form->input('600v', array('id' => '600v', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$x</b></td>
		<td>Subdivisión de materia general.</td>
		<td><?php echo $this->Form->input('600x', array('id' => '600x', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$y</b></td>
		<td>Subdivisión cronológica.</td>
		<td><?php echo $this->Form->input('600y', array('id' => '600y', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>Subdivisión geográfica.</td>
		<td><?php echo $this->Form->input('600z', array('id' => '600z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>610</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional de materia - Nombre de entidad corporativa.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Tipo de elemento inicial del nombre de entidad corporativa.</td>
		<td><?php echo $this->Form->input('610i1', array('id' => '610i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Nombre en orden inverso',
				'1' => '1 - Nombre de jurisdicción',
				'2' => '2 - Nombre en orden directo'
	...
	<tr>
		<td><b>I2</b></td>
		<td>Tesauro.</td>
		<td><?php echo $this->Form->input('610i2', array('id' => '610i2', 'label' => false, 'div' => false,
			'options' => array(
				'0' => '0 - Encabezamientos de Materia de la Library of Congress',
				'1' => '1 - Encabezamientos de Materia de LC para literatura infantil',
				'2' => '2 - Encabezamientos de Materia de Medicina',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('610a', array('id' => '610a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Unidad subordinada.</td>
		<td><?php echo $this->Form->input('610b', array('id' => '610b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Término indicativo de función.</td>
		<td><?php echo $this->Form->input('610e', array('id' => '610e', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$v</b></td>
		<td>Subdivisión de forma.</td>
		<td><?php echo $this->Form->input('610v', array('id' => '610v', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$x</b></td>
		<td>Subdivisión de materia general.</td>
		<td><?php echo $this->Form->input('610x', array('id' => '610x', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$y</b></td>
		<td>Subdivisión cronológica.</td>
		<td><?php echo $this->Form->input('610y', array('id' => '610y', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>Subdivisión geográfica.</td>
		<td><?php echo $this->Form->input('610z', array('id' => '610z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>650</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional de materia – Término de materia.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('650i1', array('id' => '650i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		<td><b>I2</b></td>
		<td>Tesauro.</td>
		<td><?php echo $this->Form->input('650i2', array('id' => '650i2', 'label' => false, 'div' => false,
			'options' => array(
				'0' => '0 - Encabezamientos de Materia de la Library of Congress',
				'1' => '1 - Encabezamientos de Materia de LC para literatura infantil',
				'2' => '2 - Encabezamientos de Materia de Medicina',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Materia.</td>
		<td><?php echo $this->Form->input('650a', array('id' => '650a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$v</b></td>
		<td>Subdivisión de forma.</td>
		<td><?php echo $this->Form->input('650v', array('id' => '650v', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$x</b></td>
		<td>Subdivisión de materia general.</td>
		<td><?php echo $this->Form->input('650x', array('id' => '650x', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$y</b></td>
		<td>Subdivisión cronológica.</td>
		<td><?php echo $this->Form->input('650y', array('id' => '650y', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>Subdivisión geográfica.</td>
		<td><?php echo $this->Form->input('650z', array('id' => '650z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>651</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional de materia - Nombre geográfico.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Nivel de materia.</td>
		<td><?php echo $this->Form->input('651i1', array('id' => '651i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se proporciona información',
				'0' => '0 - No se especifica',
				'1' => '1 - Principal',
	...
	<tr>
		<td><b>I2</b></td>
		<td>Tesauro.</td>
		<td><?php echo $this->Form->input('651i2', array('id' => '651i2', 'label' => false, 'div' => false,
			'options' => array(
				'0' => '0 - Encabezamientos de Materia de la Library of Congress',
				'1' => '1 - Encabezamientos de Materia de LC para literatura infantil',
				'2' => '2 - Encabezamientos de Materia de Medicina',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Materia.</td>
		<td><?php echo $this->Form->input('651a', array('id' => '651a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$v</b></td>
		<td>Subdivisión de forma.</td>
		<td><?php echo $this->Form->input('651v', array('id' => '651v', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$x</b></td>
		<td>Subdivisión de materia general.</td>
		<td><?php echo $this->Form->input('651x', array('id' => '651x', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$y</b></td>
		<td>Subdivisión cronológica.</td>
		<td><?php echo $this->Form->input('651y', array('id' => '651y', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>Subdivisión geográfica.</td>
		<td><?php echo $this->Form->input('651z', array('id' => '651z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>653</b></td>
		<td style="width: 60%;"><b>Término de indización – No controlado.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('653i1', array('id' => '653i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se proporciona información',
				'0' => '0 - No se especifica',
				'1' => '1 - Principal',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('653i2', array('id' => '653i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('653a', array('id' => '653a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>690</b></td>
		<td style="width: 60%;"><b>Siglo.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('690a', array('id' => '690a', 'label' => false, 'div' => false, 'empty' => 'Seleccione', 'options' => array('XVII' => 'XVII', 'XVIII' => 'XVIII', 'XIX' => 'XIX', 'XX' => 'XX'))); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>700</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional - Nombre personal.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Tipo de elemento inicial del nombre de persona.</td>
		<td><?php echo $this->Form->input('700i1', array('id' => '700i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Nombre',
				'1' => '1 - Apellido(s)',
				'3' => '3 - Nombre de familia'
	...
	<tr>
		...
		<td><?php echo $this->Form->input('700i2', array('id' => '700i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Nombre de persona.</td>
		<td><?php echo $this->Form->input('700a', array('id' => '700a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Numeración.</td>
		<td><?php echo $this->Form->input('700b', array('id' => '700b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Títulos y otros términos asociados al nombre.</td>
		<td><?php echo $this->Form->input('700c', array('id' => '700c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Fechas asociadas al nombre.</td>
		<td><?php echo $this->Form->input('700d', array('id' => '700d', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Término indicativo de función.</td>
		<td><?php echo $this->Form->input('700e', array('id' => '700e', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$q</b></td>
		<td>Forma desarrollada del nombre.</td>
		<td><?php echo $this->Form->input('700q', array('id' => '700q', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$t</b></td>
		<td>Título de la obra.</td>
		<td><?php echo $this->Form->input('700t', array('id' => '700t', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$4</b></td>
		<td>Código de función.</td>
		<td><?php echo $this->Form->input('7004', array('id' => '7004', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>710</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional - Nombre corporativo.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Tipo de elemento inicial del nombre de persona.</td>
		<td><?php echo $this->Form->input('710i1', array('id' => '710i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Nombre en orden inverso',
				'1' => '1 – Nombre de jurisdicción',
	...
	<tr>
		<td><b>I2</b></td>
		<td>Tipo de punto de acceso adicional.</td>
		<td><?php echo $this->Form->input('710i2', array('id' => '710i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
				'2' => '2 - Entrada analítica'
			)
	...
	<tr>
		<td><b>$a</b></td>
		<td>Nombre de persona.</td>
		<td><?php echo $this->Form->input('710a', array('id' => '710a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Numeración.</td>
		<td><?php echo $this->Form->input('710b', array('id' => '710b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Forma desarrollada del nombre.</td>
		<td><?php echo $this->Form->input('710e', array('id' => '710e', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$t</b></td>
		<td>Título de la obra.</td>
		<td><?php echo $this->Form->input('710t', array('id' => '710t', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$4</b></td>
		<td>Código de función.</td>
		<td><?php echo $this->Form->input('7104', array('id' => '7104', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>740</b></td>
		<td style="width: 60%;"><b>Punto de acceso adicional - Título relacionado o analítico no controlado.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		<td><b>I1</b></td>
		<td>Caracteres que no alfabetizan.</td>
		<td><?php echo $this->Form->input('740i1', array('id' => '740i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0',
				'1' => '1',
				'2' => '2',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('740i2', array('id' => '740i2', 'label' => false, 'div' => false,
			'options' => array(
				'0' => '0 - No hay punto de acceso adicional',
				'1' => '1 - Hay punto de acceso adicional'
			), 'selected' => '1'
	...
	<tr>
		...
		<td><?php echo $this->Form->input('740a', array('id' => '740a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número de la parte o sección de una obra.</td>
		<td><?php echo $this->Form->input('740n', array('id' => '740n', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de la parte/sección de una obra.</td>
		<td><?php echo $this->Form->input('740p', array('id' => '740p', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>773</b></td>
		<td style="width: 60%;"><b>Enlace al documento fuente.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('773i1', array('id' => '773i1', 'label' => false, 'div' => false, 
			'options' => array(
				'0' => '0 - Genera nota',
				'1' => '1 - No genera nota'
			), 'selected' => '1'
	...
	<tr>
		<td><b>I2</b></td>
		<td>Control de visualización asociada.</td>
		<td><?php echo $this->Form->input('773i2', array('id' => '773i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - En',
				'8' => '8 - No genera visualización asociada'
			)
	...
	<tr>
		<td><b>$a</b></td>
		<td>Autor.</td>
		<td><?php echo $this->Form->input('773a', array('id' => '773a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Edición.</td>
		<td><?php echo $this->Form->input('773b', array('id' => '773b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Lugar, editor y fecha de publicación.</td>
		<td><?php echo $this->Form->input('773d', array('id' => '773d', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$g</b></td>
		<td>Parte(s) relacionada(s).</td>
		<td><?php echo $this->Form->input('773g', array('id' => '773g', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
		<td>Descripción física.</td>
		<td><?php echo $this->Form->input('773h', array('id' => '773h', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$k</b></td>
		<td>Datos de la serie del documento relacionado.</td>
		<td><?php echo $this->Form->input('773k', array('id' => '773k', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Nota.</td>
		<td><?php echo $this->Form->input('773n', array('id' => '773n', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$q</b></td>
		<td>Numeración y primera página.</td>
		<td><?php echo $this->Form->input('773q', array('id' => '773q', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$t</b></td>
		<td>Título.</td>
		<td><?php echo $this->Form->input('773t', array('id' => '773t', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$z</b></td>
		<td>Número Internacional Normalizado para Libros (ISBN).</td>
		<td><?php echo $this->Form->input('773z', array('id' => '773z', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
</div>
...
<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>850</b></td>
		<td style="width: 60%;"><b>Institución que posee los fondos.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('850a', array('id' => '850a', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>852</b></td>
		<td style="width: 60%;"><b>Localización.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('852i1', array('id' => '852i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('852i2', array('id' => '852i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
				'0' => '0 - Sin numeración',
	...
	<tr>
		<td><b>$a</b></td>
		<td>Localización.</td>
		<td><?php echo $this->Form->input('852a', array('id' => '852a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Sublocalización o colección.</td>
		<td><?php echo $this->Form->input('852b', array('id' => '852b', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Ubicación en estantería.</td>
		<td><?php echo $this->Form->input('852c', array('id' => '852c', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
		<td>Parte de la signatura que corresponde a la clasificación.</td>
		<td><?php echo $this->Form->input('852h', array('id' => '852h', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$i</b></td>
		<td>Parte de la signatura que identifica al ejemplar.</td>
		<td><?php echo $this->Form->input('852i', array('id' => '852i', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$j</b></td>
		<td>Número de control en estantería.</td>
		<td><?php echo $this->Form->input('852j', array('id' => '852j', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$k</b></td>
		<td>Prefijo de la signatura.</td>
		<td><?php echo $this->Form->input('852k', array('id' => '852k', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$m</b></td>
		<td>Sufijo de la signatura.</td>
		<td><?php echo $this->Form->input('852m', array('id' => '852m', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>

<table class="mytable">
	<tr>
		<td style="width: 5%;"><b>856</b></td>
		<td style="width: 60%;"><b>Localización y acceso electrónicos.</b></td>
		<td style="width: 35%;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('856i1', array('id' => '856i1', 'label' => false, 'div' => false, 
			'options' => array(
				'#' => '# - No se proporciona información',
	...
	<tr>
		<td><b>I2</b></td>
		<td>Relación.</td>
		<td><?php echo $this->Form->input('856i2', array('id' => '856i2', 'label' => false, 'div' => false,
			'options' => array(
				'#' => '# - No se proporciona información',
				'0' => '0 - Recurso',
	...
	<tr>
		...
		<td><?php echo $this->Form->input('856a', array('id' => '856a', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Ruta.</td>
		<td><?php echo $this->Form->input('856d', array('id' => '856d', 'label' => false, 'div' => false)); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Dirección electrónica.</td>
		<td><?php echo $this->Form->input('856u', array('id' => '856u', 'label' => false, 'div' => false)); ?></td>
	</tr>
</table>
	...
	<div style="width: 100%;">
		<div style="width: 50%; float: left;"><?php echo $this->Form->input('cover', array('label' => 'Portada de la obra (preferiblemente jpg o gif).', 'type' => 'file')); ?></div>
		<div style="width: 50%; float: left;"><?php echo $this->Form->input('item', array('label' => "Archivo o Documento (preferiblemente pdf o doc). <font color='red'>(Obligatorio)</font>.", 'type' => 'file')); ?></div>
	</div>
	
	<?php echo $this->Form->input('published', array('type' => 'checkbox', 'checked' => 'checked')); ?>
	
<?php echo $this->Form->submit('Guardar', array('id' => 'guardar')); ?>
...
<div class="actions" style="height: 350px;">
	...
	<br />
	<ul>
		<li><?php echo $this->Html->link(__('Works', true), array('action' => 'index'));?></li>
...
$(document).ready(function() {
	...
	$('td :input').attr('style', 'height: 16px;');
	$('select').attr('style', 'height: 28px;');
	$('#008-06').attr('style', 'width: 400px;');
	$('#008-07-10').attr('style', 'width: 250px;');
	$('#008-11-14').attr('style', 'width: 250px;');
	$('#008pf').attr('style', 'margin-bottom: 0px;');
	$('#008sf').attr('style', 'margin-bottom: 0px;');
	$('#600i2').attr('style', 'width: 400px;');
	$('#610i2').attr('style', 'width: 400px;');
	$('#650i2').attr('style', 'width: 400px;');
	$('#651i2').attr('style', 'width: 400px;');
	...
	$("#tipo").change(function(event) {
		...
		$("#ItemH-005 option[value=n]").attr("selected", true);
		$("#ItemH-017 option[value=7]").attr("selected", true);
		$("#ItemH-018 option[value=a]").attr("selected", true);
		
		switch (valor){
			case '1': 	$("#ItemH-006 option[value=a]").attr("selected", true);
						$("#ItemH-007 option[value=m]").attr("selected", true);
						
						break;
						
			case '2': 	$("#ItemH-006 option[value=a]").attr("selected", true);
						$("#ItemH-007 option[value=s]").attr("selected", true);
						break;
						
			case '3': 	$("#ItemH-006 option[value=a]").attr("selected", true);
						$("#ItemH-007 option[value=a]").attr("selected", true);
						break;
						
			case '4': 	$("#ItemH-006 option[value=a]").attr("selected", true);
						$("#ItemH-007 option[value=b]").attr("selected", true);
						break;
						
			case '5': 	$("#ItemH-006 option[value=c]").attr("selected", true);
						$("#ItemH-007 option[value=m]").attr("selected", true);
						break;
						
			case '6': 	$("#ItemH-006 option[value=d]").attr("selected", true);
						$("#ItemH-007 option[value=m]").attr("selected", true);
						break;
						
			case '7': 	$("#ItemH-006 option[value=c]").attr("selected", true);
						$("#ItemH-007 option[value=a]").attr("selected", true);
						break;
						
			case '8': 	$("#ItemH-006 option[value=d]").attr("selected", true);
						$("#ItemH-007 option[value=a]").attr("selected", true);
						break;
						
			case '9': 	$("#ItemH-006 option[value=c]").attr("selected", true);
						$("#ItemH-007 option[value=b]").attr("selected", true);
						break;
			
			case '10': 	$("#ItemH-006 option[value=c]").attr("selected", true);
						$("#ItemH-007 option[value=c]").attr("selected", true);
						break;
			
			case '11': 	$("#ItemH-006 option[value=d]").attr("selected", true);
						$("#ItemH-007 option[value=c]").attr("selected", true);
						break;
						
			case '12': 	$("#ItemH-006 option[value=k]").attr("selected", true);
						$("#ItemH-007 option[value=m]").attr("selected", true);
						break;
						
			case '13': 	$("#ItemH-006 option[value=k]").attr("selected", true);
						$("#ItemH-007 option[value=a]").attr("selected", true);
						break;
						
			case '14': 	$("#ItemH-006 option[value=k]").attr("selected", true);
						$("#ItemH-007 option[value=b]").attr("selected", true);
						break;
		}
	});
	...
	$('#ItemAddForm').submit(function(event) {
		if ($('#100a').val() == ""){
