...
<ul class="breadcrumb" style="margin: 0">
  ...
  <?php } else { ?>
  <li><a href="<?php echo $this->base; ?>/books/author">Autor</a><span class="divider">/</span></li>
...
<table style="font-size: smaller; width: 75%;">
	<tr>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><strong><a href="<?php echo $this->base; ?>/books">Presentación</a></strong></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/century">Siglo</a></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s2.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/author">Autor</a></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/title">Título</a></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/year">Año</a></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/matter">Materia</a></td>
	</tr>
</table>
</div>
...
<?php //} ?>
<div style="clear: both;"><?php echo $this->Html->image('ts/pestana_libros.jpg'); ?><br /><br /></div>
</div>