...
<table style="font-size: smaller; width: 75%;">
	<tr>
		...
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s1.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/author">Autor</a></td>
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smlibros_s2.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/title">Título</a></td>
